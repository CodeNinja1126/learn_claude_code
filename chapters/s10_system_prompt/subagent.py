...
from messages import append_tool_result, message_to_dict, parse_tool_args
from tool import TOOL_HANDLERS, TOOLS, tool_subset
...
SUB_TOOLS, SUB_HANDLERS = tool_subset(SUB_TOOL_NAMES)
...
def spawn_subagent(description: str) -> str:
    ...
    for _ in range(30):
        ...
        for tool_call in message.tool_calls:
            ...
            append_tool_result(messages, tool_call.id, output)
